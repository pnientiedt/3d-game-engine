...
public class Game {
	...
	public void input() {
		...
		// System.out.println("We've pressed key UP");
		// }
		// if (Input.getKeyUp(Input.KEY_UP)) {
		// System.out.println("We've released key UP");
		// }
		//
		// if (Input.getMouseDown(1)) {
		// System.out.println("We've just right clicked at " +
		// Input.getMousePosition().toString());
		// }
		// if (Input.getMouseUp(1)) {
		// System.out.println("We've released right mouse button!");
		// }
	}
